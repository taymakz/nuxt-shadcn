...

  {
    variants: {
      variant: {
        ...
        'default':
          'bg-card text-card-foreground focus:border-border-lighter hover:border-border-lighter placeholder:text-card-muted relative block w-full rounded-lg border px-5 py-3 duration-200 placeholder:text-sm placeholder:duration-200 placeholder:select-none focus:placeholder:-translate-x-2 disabled:opacity-50 ltr:text-left ltr:placeholder:text-right',
